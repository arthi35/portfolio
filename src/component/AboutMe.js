    ...
    >
      ...
      <div className="About_wrapper">
        <div className="about_text">
          <p>
            I am <span className="about_span"></span> highly
            <span className="about_span"> passionate</span> and quickly
            <span className="about_span"> adaptable</span> person and my aim is to work 
            as a developer in a challenging organization 
            where I can learn
